...
import static com.professionalpractice.weatherapp.location.CityFinder.getCityNameUsingNetwork;
import static com.professionalpractice.weatherapp.location.CityFinder.setLongitudeLatitude;
import static com.professionalpractice.weatherapp.network.InternetConnectivity.isInternetConnected;
...
import com.professionalpractice.weatherapp.adapter.DaysAdapter;
import com.professionalpractice.weatherapp.databinding.ActivityHomeBinding;
import com.professionalpractice.weatherapp.firebase.FirebaseHelper;
import com.professionalpractice.weatherapp.location.LocationCord;
import com.professionalpractice.weatherapp.toast.Toaster;
import com.professionalpractice.weatherapp.update.UpdateUI;
import com.professionalpractice.weatherapp.url.URL;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // checkUpdate();
        ...
        updateDisplayedWelcomeMessage();
    }

    private void updateDisplayedWelcomeMessage() {
        FirebaseUser user = FirebaseHelper.getCurrentUser();

        if (user != null) {

            String welcomeMessage = "Welcome, " + user.getDisplayName().split(" ")[0];
            binding.layout.welcomeTv.setText(welcomeMessage);
        }
    ...
    private void listeners() {
        ...
        //Profile Image
        binding.layout.profileImage.setOnClickListener(view -> {
